/* XXX This code generated automatically by gen-testcases.hs
   ...
   manually edit this file. */
    ...
    result |= test(48, "042.90", "%06.2f", 42.8952);
    ...
    result |= test(62, "0000003.14", "%0*.*f", 10, 2, 3.14159265);
    ...
    /* 121: excluded for C */
    result |= test(122, "1", "%I0d", 1);
    result |= test(123, "                               1", "%I32d", 1);
    /* 124: excluded for C */
    ...
    result |= test(158, " 0008.6000e+00", "% 014.4e", 8.6);
